export default {
  ...
  comments: {
    ...
    error_forbidden: 'You do not have permission to post a comment on this task.',
    error_file_missing: 'One of the selected files could not be read. Please attach it again and retry.',
    error_invalid: 'The comment could not be posted. Please check the status, comment text, link, and attachments, then try again.',
    error_network: 'The comment could not be posted because the network connection was interrupted. Please try again.',
    error_preview_format: 'One of the selected preview files has an unsupported format.',
    error_preview_partial: 'The comment may already be posted, but publishing preview files failed. Refresh the page before trying again.',
    error_preview_processing: 'The preview file could not be processed. Please try again or upload a different file.',
    error_preview_revision_exists: 'This revision already exists for the task. Choose a different revision number.',
    error_task_missing: 'The comment could not be posted because this task is no longer available.',
    error_timeout: 'Posting the comment took too long. Please wait a moment and try again.',
    error_too_large: 'The comment could not be posted because one or more attachments are too large.',
